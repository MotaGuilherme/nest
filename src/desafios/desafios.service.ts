...
import {Desafios, Partida} from "./interfaces/desafios.interface";
import {BadRequestException, Injectable, InternalServerErrorException, Logger, NotFoundException} from "@nestjs/common";
import {CriarDesafiosDto} from "./dtos/criar-desafios.dto";
...
export class DesafiosService {
	...
	async criarDesafio(criarDesafioDto: CriarDesafiosDto): Promise<Desafios> {
		...
		// const categoriaDoJogador = await this.categoriasService.consultarCategoria(criarDesafioDto.solicitante)
		//
	...
	async consultarTodosDesafios(): Promise<Array<Desafios>> {
	...
	async consultarDesafiosDeUmJogador(_id: any): Promise<Array<Desafios>> {
